...
describe("SetIntegrationManager", () => {
    ...
    it("should update integrations provisioning on toggle", () => {
        ...
        fireEvent.click(within(integrationSection).getByRole("switch", { name: "Enable the integration manager" }));
        ...
        expect(within(integrationSection).getByRole("switch", { name: "Enable the integration manager" })).toBeChecked();
    });
    it("handles error when updating setting fails", async () => {
        ...
        await waitFor(() => expect(within(integrationSection).getByRole("switch", { name: "Enable the integration manager" })).not.toBeChecked());
    });
});
