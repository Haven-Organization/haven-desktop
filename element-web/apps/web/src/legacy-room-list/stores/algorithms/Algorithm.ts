...
import { EffectiveMembership, getEffectiveMembershipTag } from "../../../utils/membership";
...
// Haven: only the old room list still needs a raw membership split - see index.ts's own doc.
type MembershipSplit = {
    [EffectiveMembership.Invite]: Room[];
    [EffectiveMembership.Join]: Room[];
    [EffectiveMembership.Leave]: Room[];
};

function splitRoomsByMembership(rooms: Room[]): MembershipSplit {
