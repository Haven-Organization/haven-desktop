...
import { SortAlgorithm, ListAlgorithm } from "../../../../../src/legacy-room-list/stores/algorithms/models";
import "../../../../../src/legacy-room-list/stores/RoomListStore"; // must be imported before Algorithm to avoid cycles
import { Algorithm } from "../../../../../src/legacy-room-list/stores/algorithms/Algorithm";
